...
function getLastUpdated(time) {
   return moment(Date.now() - 60 * 1000).fromNow()
}
        ...
        <div className="root">
            <div className="basic-info">
                <h3 className="repo-title">
                    <Link href={`detail?owner=${repo.owner.login}&=${repo.name}`}>
                        <a>{repo.full_name}</a>
                    </Link>
                </h3>
                ...
                <p className="other-info">
                    ...
                    <span className="open-iusses">{repo.open_issues_count} open issues</span>
                </p>
            </div>
